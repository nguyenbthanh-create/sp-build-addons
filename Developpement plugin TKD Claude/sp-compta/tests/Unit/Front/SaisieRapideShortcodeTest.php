...
/**
 * Scenarios BDD documentes dans src/Front/SaisieRapideShortcode.md
 */
final class SaisieRapideShortcodeTest extends WP_UnitTestCase
{
    private SaisieRapideShortcode $shortcode;
    ...
    public function setUp(): void
    {
        ...
        $this->shortcode = new SaisieRapideShortcode($depenseScreen, $this->exerciceRepository, $fournisseurRepository);
    }
